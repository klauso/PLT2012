 ...
 \item Give the \term{(structural) evaluation semantics} (aka. \term{(structural)
  ...
  \begin{mathpar}
   ...
   \inferrule
    ...
    {\eval{e_1\ o\ e_2}{\inucorners{\appl{op}{o, v_1, v_2}}}}\ \textsc{EvC}
  \end{mathpar}
  ...
  \begin{mathpar}
   \inferrule
    {\inferrule
      {\inferrule
        { }
        {\eval{\texttt{1}}{\texttt{1}}}\ \textsc{EvV}
       \and
       \inferrule
        {\inferrule
          { }
          {\eval{\texttt{2}}{\texttt{2}}}\ \textsc{EvV}
         \and
         \inferrule
          { }
          {\eval{\texttt{3}}{\texttt{3}}}\ \textsc{EvV} }
        {\eval{\texttt{2 * 3}}{\inucorners{\appl{op}{*, 2, 3}}} = \texttt{6}}\ \textsc{EvC} }
      {\eval{\texttt{1 + 2 * 3}}{\inucorners{\appl{op}{+, 1, 6}}} = \texttt{7}}\ \textsc{EvC}
     \and
     \inferrule
      { }
      {\eval{\texttt{4}}{\texttt{4}}}\ \textsc{EvV} }
    {\eval{\texttt{1 + 2 * 3 - 4}}{\inucorners{\appl{op}{-, 7, 4}}} = \texttt{3}}\ \textsc{EvC}
  \end{mathpar} }
