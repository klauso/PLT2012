 ...
 *    Such a function will contain free variables.
 ...
 * call `addc2' and `appc1' must call `appc2'. The rest of the transformation is a straightforward
 ...
 *
 * Finally, the `apply' function needs to know about the argument to the function. These become additional parameters of
 * the `apply' function.
 *
